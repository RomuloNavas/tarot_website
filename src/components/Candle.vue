...
<template>
  <div id="candle_animation" @click="appState.isBigFire = !appState.isBigFire">
    <div class="candle">
      <div class="flame">
        <div v-show="appState.isBigFire" class="shadows" />
        <div v-show="appState.isBigFire" class="top" />
        <div v-show="appState.isBigFire" class="middle" />
        <div class="bottom" />
        <div class="little-fire" />
      </div>
      <div class="wick" />
      <div class="wax" />
    </div>
...
.wax {
  ...
  top: 15px;
  width: 100%;
  height: 290px; // makes wow effect wooow
